def add_arguments(parser):
    ...
    parser.add_argument('--num_steps', type=int, default = 2500000, help='Number of episodes the agent plays')
    ...
    parser.add_argument('--exploration_steps', type=int, default = 900000, help='Number of steps over which the initial value of epsilon is linearly annealed to its final value')
    parser.add_argument('--initial_epsilon', type=float, default = .75, help='Initial value of epsilon in epsilon-greedy')
    parser.add_argument('--final_epsilon', type=float, default = 0.01, help='Final value of epsilon in epsilon-greedy')
    parser.add_argument('--initial_replay_size', type=int, default =25000, help='Number of steps to populate the replay memory before training starts')
    parser.add_argument('--num_replay_memory', type=int, default = 800000, help='Number of replay memory the agent uses for training')
    ...
    parser.add_argument('--save_interval', type=int, default = 50000, help='The frequency with which the network is saved')
    ...
    parser.add_argument('--test_dqn_model_path', type=str, default = "saved_dqn_networks/DDDQN_Litter_Agent_reward_50000.h5", help='model used during testing / visulization')
    parser.add_argument('--exp_name', type=str, default = "DDDQN_Litter_Agent_reward", help='')
