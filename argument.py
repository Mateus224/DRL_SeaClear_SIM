def add_arguments(parser):
    ...
    parser.add_argument('--initial_replay_size', type=int, default = 32, help='Number of steps to populate the replay memory before training starts')
    parser.add_argument('--num_replay_memory', type=int, default = 250000, help='Number of replay memory the agent uses for training')
    ...
    parser.add_argument('--test_dqn_model_path', type=str, default = "saved_dqn_networks/DDDQN_Litter_Agent_50000.h5", help='model used during testing / visulization')
