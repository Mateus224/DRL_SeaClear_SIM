def add_arguments(parser):
    ...
    parser.add_argument('--num_steps', type=int, default = 2000000, help='Number of episodes the agent plays')
    ...
    parser.add_argument('--exploration_steps', type=int, default = 50000, help='Number of steps over which the initial value of epsilon is linearly annealed to its final value')
    parser.add_argument('--initial_epsilon', type=float, default = 0.200, help='Initial value of epsilon in epsilon-greedy')
    parser.add_argument('--final_epsilon', type=float, default = 0.005, help='Final value of epsilon in epsilon-greedy')
    parser.add_argument('--initial_replay_size', type=int, default =20000, help='Number of steps to populate the replay memory before training starts')
    parser.add_argument('--num_replay_memory', type=int, default = 200000, help='Number of replay memory the agent uses for training')
    ...
    parser.add_argument('--test_dqn_model_path', type=str, default = "saved_dqn_networks/DDDQN_Litter_Agent_200000.h5", help='model used during testing / visulization')
