def add_arguments(parser):
    ...
    parser.add_argument('--exploration_steps', type=int, default = 400000, help='Number of steps over which the initial value of epsilon is linearly annealed to its final value')
    parser.add_argument('--initial_epsilon', type=float, default = .03, help='Initial value of epsilon in epsilon-greedy')
    parser.add_argument('--final_epsilon', type=float, default = 0.02, help='Final value of epsilon in epsilon-greedy')
    parser.add_argument('--initial_replay_size', type=int, default =15000, help='Number of steps to populate the replay memory before training starts')
    ...
    parser.add_argument('--test_dqn_model_path', type=str, default = "saved_dqn_networks/DDDQN_Litter_Agent_matrix_800000.h5", help='model used during testing / visulization')
    parser.add_argument('--exp_name', type=str, default = "DDDQN_Litter_Agent_matrix01", help='')
