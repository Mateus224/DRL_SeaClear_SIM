def add_arguments(parser):
    ...
    parser.add_argument('--exploration_steps', type=int, default = 750000, help='Number of steps over which the initial value of epsilon is linearly annealed to its final value')
    ...
    parser.add_argument('--test_dqn_model_path', type=str, default = "saved_dqn_networks/DDDQN_Litter_Agent_matrix_150000.h5", help='model used during testing / visulization')
