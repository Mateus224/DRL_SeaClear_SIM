def add_arguments(parser):
    ...
    parser.add_argument('--num_steps', type=int, default = 5000000, help='Number of episodes the agent plays')
    ...
    parser.add_argument('--save_interval', type=int, default = 10000, help='The frequency with which the network is saved')
    ...
    parser.add_argument('--test_dqn_model_path', type=str, default = "saved_dqn_networks/DDDQN_Litter_Agent_2420000.h", help='model used during testing / visulization')
