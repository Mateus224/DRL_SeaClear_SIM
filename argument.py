def add_arguments(parser):
    ...
    parser.add_argument('--exploration_steps', type=int, default = 600000, help='Number of steps over which the initial value of epsilon is linearly annealed to its final value')
    parser.add_argument('--initial_epsilon', type=float, default = 1., help='Initial value of epsilon in epsilon-greedy')
    ...
    parser.add_argument('--num_replay_memory', type=int, default = 500000, help='Number of replay memory the agent uses for training')
    ...
    parser.add_argument('--test_dqn_model_path', type=str, default = "saved_dqn_networks/DDDQN_Litter_Agent_matrix_675000.h5", help='model used during testing / visulization')
    parser.add_argument('--exp_name', type=str, default = "DDDQN_Litter_Agent_matrix", help='')
