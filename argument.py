def add_arguments(parser):
    ...
    parser.add_argument('--num_steps', type=int, default = 1000000, help='Number of episodes the agent plays')
    ...
    parser.add_argument('--exploration_steps', type=int, default = 100000, help='Number of steps over which the initial value of epsilon is linearly annealed to its final value')
    ...
    parser.add_argument('--test_dqn_model_path', type=str, default = "saved_dqn_networks/DDDQN_Litter_Agent_750000.h5", help='model used during testing / visulization')
    parser.add_argument('--exp_name', type=str, default = "DDDQN_Litter_Agent", help='')
