...
try:
    ...
    class Figure:
        ...
        def __init__(self, window_name="Open3D", width=1920, height=1080,
            ...
            if with_key_callbacks:
                ...
                self.visualizer2 = o3d.visualization.VisualizerWithKeyCallback()
            else:
                self.visualizer = o3d.visualization.Visualizer()
                self.visualizer2 = o3d.visualization.Visualizer()
            self.visualizer.create_window(
                window_name=window_name, width=width, height=height)
            self.visualizer2.create_window(
                window_name=window_name, width=width, height=height)
        ...
        def add_geometry2(self, geometry):
            """Add geometry to visualizer.
            ...
            geometry : Geometry
                Open3D geometry.
            """
            self.visualizer2.add_geometry(geometry)
        ...
        def remove_geometry2(self, geometry):
            """Remove geometry to visualizer.
            ...
            geometry : Geometry
                Open3D geometry.
            """
            self.visualizer2.remove_geometry(geometry)
        ...
        def set_line_width(self, line_width):
            ...
            self.visualizer2.get_render_option().line_width = line_width
            self.visualizer2.update_renderer()
        ...
        def animate(self, callback, n_frames, loop=False, fargs=()):
            ...
            while window_open and (loop or not initialized):
                for i in range(n_frames):
                    ...
                    for a in drawn_artists:
                        if type(a) is list:
                            for i in range(len(a)):
                                for geometry in a[i].geometries:
                                    self.update_geometry2(geometry)
                    ...
                    window_open2 = self.visualizer2.poll_events()
                    if not (window_open and window_open2):
                        break
                    self.visualizer2.update_renderer()
                    self.visualizer.update_renderer()
        ...
        def plot(self, P,A2B, c=(0, 0, 0)):
            ...
            line3d = Line3D(P,A2B, c)
            line3d.add_artist(self)
            line3d.add_artist2(self)
            return line3d
        ...
        def plot_basis(self, R=None, p=np.zeros(3), s=1.0, strict_check=True):
            ...
            frame.add_artist2(self)

            return frame
            
        def plot_basis2(self, R=None, p=np.zeros(3), s=1.0, strict_check=True):
            """Plot basis.
        ...
        def show(self):
            ...
            self.visualizer2.run()
            self.visualizer2.destroy_window()
    ...
    class Line3D(Artist):
        ...
        c : array-like, shape (n_points - 1, 3) or (3,), optional (default: black)
            ...
            0 and 1 indicate representing red, green, and blue respectively.
        """
        def __init__(self, P, A2B, c=(0, 0, 0)):
        ...
        def set_data(self, P, A2B, c=None):
            ...
            self.line_set.transform(pt.invert_transform(previous_A2B, check=False))
            self.line_set.transform(self.A2B)
